...
import (
	...
	handmade "github.com/trainyao/playground/k8s/crd-controller/handmade/pkg/client/informers/externalversions/handmade"
...
type SharedInformerFactory interface {
	...
	Handmade() handmade.Interface
}

func (f *sharedInformerFactory) Handmade() handmade.Interface {
	return handmade.New(f, f.namespace, f.tweakListOptions)
}
